...
//    return CommonUtil.removeTime(screenedDate);
	...
	public String toString() {
		return "CandidateDTO [id=" + id + ", resumeUploaded=" + resumeUploaded + ", contact=" + contact + ", search="
				+ search + ", kgpInterviewDate1=" + kgpInterviewDate1 + ", kgpInterviewDate2=" + kgpInterviewDate2
				+ ", kgpInterviewDate3=" + kgpInterviewDate3 + ", interviews=" + interviews + ", degreeVerification="
				+ degreeVerification + ", offerPresented=" + offerPresented + ", athenaCompleted=" + athenaCompleted
				+ ", athenaStatus=" + athenaStatus + ", contactId=" + contactId + "]";
	}
